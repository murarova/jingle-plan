...
const modalStyle = tva({
  base: 'group/modal absolute inset-0 web:w-full web:h-full justify-center items-center web:pointer-events-none',
  variants: {
    size: {
      xs: '',
      sm: '',
...
const modalBackdropStyle = tva({
  base: 'absolute left-0 top-0 right-0 bottom-0 bg-typography-950/50 web:cursor-default',
});

const modalContentStyle = tva({
  base: 'bg-backgroundLight-50 rounded-lg overflow-hidden',
  parentVariants: {
    size: {
      xs: 'w-[60%] max-w-[360px]',
      sm: 'w-[70%] max-w-[420px]',
...
const modalFooterStyle = tva({
  base: 'p-4 flex-row justify-end items-center gap-2 flex-wrap',
});
