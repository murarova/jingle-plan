...
const actionsheetStyle = tva({
  base: 'absolute inset-0 web:w-full web:h-full web:pointer-events-none',
});

const actionsheetContentStyle = tva({
  base: 'items-center rounded-tl-3xl rounded-tr-3xl p-2 bg-white max-h-[70%] web:pointer-events-auto web:select-none shadow-hard-5 pb-safe',
});

const actionsheetItemStyle = tva({
  base: 'w-full flex-row items-center p-3 rounded-sm data-[disabled=true]:opacity-40 data-[disabled=true]:web:pointer-events-auto data-[disabled=true]:web:cursor-not-allowed data-[hover=true]:bg-backgroundLight-100 data-[active=true]:bg-backgroundLight-200 data-[checked=true]:bg-backgroundLight-300 data-[focus=true]:bg-backgroundLight-100 web:data-[focus-visible=true]:bg-backgroundLight-100',
});
...
const actionsheetDragIndicatorStyle = tva({
  base: 'w-16 h-1 bg-backgroundLight-400 rounded-full',
});
...
const actionsheetBackdropStyle = tva({
  base: 'absolute left-0 top-0 right-0 bottom-0 bg-typography-950/50 web:cursor-default web:pointer-events-auto',
});
